...
func (ec *executionContext) _Query_stationByCD(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	fc.Result = res
	return ec.marshalNStation2ᚖgithubᚗcomᚋgoᚑgraphqlᚑdemoᚋgraphᚋmodelᚐStation(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Query_stationByName(ctx context.Context, field graphql.CollectedField) (ret graphql.Marshaler) {
	...
	res := resTmp.([]*model.Station)
	fc.Result = res
	return ec.marshalOStation2ᚕᚖgithubᚗcomᚋgoᚑgraphqlᚑdemoᚋgraphᚋmodelᚐStation(ctx, field.Selections, res)
}
...
func (ec *executionContext) _Station_beforeStation(ctx context.Context, field graphql.CollectedField, obj *model.Station) (ret graphql.Marshaler) {
	...
	res := resTmp.(*model.Station)
	fc.Result = res
	return ec.marshalOStation2ᚖgithubᚗcomᚋgoᚑgraphqlᚑdemoᚋgraphᚋmodelᚐStation(ctx, field.Selections, res)
}
...
func (ec *executionContext) marshalNStation2githubᚗcomᚋgoᚑgraphqlᚑdemoᚋgraphᚋmodelᚐStation(ctx context.Context, sel ast.SelectionSet, v model.Station) graphql.Marshaler {
	return ec._Station(ctx, sel, &v)
}

func (ec *executionContext) marshalNStation2ᚖgithubᚗcomᚋgoᚑgraphqlᚑdemoᚋgraphᚋmodelᚐStation(ctx context.Context, sel ast.SelectionSet, v *model.Station) graphql.Marshaler {
	if v == nil {
		if !graphql.HasFieldError(ctx, graphql.GetFieldContext(ctx)) {
			ec.Errorf(ctx, "must not be null")
		}
...
func (ec *executionContext) marshalOStation2ᚕᚖgithubᚗcomᚋgoᚑgraphqlᚑdemoᚋgraphᚋmodelᚐStation(ctx context.Context, sel ast.SelectionSet, v []*model.Station) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	ret := make(graphql.Array, len(v))
	...
	for i := range v {
		...
		f := func(i int) {
			...
			ret[i] = ec.marshalOStation2ᚖgithubᚗcomᚋgoᚑgraphqlᚑdemoᚋgraphᚋmodelᚐStation(ctx, sel, v[i])
		}
		if isLen1 {
			f(i)
		} else {
...
func (ec *executionContext) marshalOStation2ᚖgithubᚗcomᚋgoᚑgraphqlᚑdemoᚋgraphᚋmodelᚐStation(ctx context.Context, sel ast.SelectionSet, v *model.Station) graphql.Marshaler {
	if v == nil {
		return graphql.Null
	}
	return ec._Station(ctx, sel, v)
