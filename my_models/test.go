...
var TestWhere = struct {
	...
	ID:   whereHelperstring{field: "\"test\".\"id\""},
...
var (
	testAllColumns            = []string{"id", "name"}
	testColumnsWithoutDefault = []string{"id", "name"}
	testColumnsWithDefault    = []string{}
...
func FindTest(ctx context.Context, exec boil.ContextExecutor, iD string, selectCols ...string) (*Test, error) {
	testObj := &Test{}
...
func TestExists(ctx context.Context, exec boil.ContextExecutor, iD string) (bool, error) {
	var exists bool
